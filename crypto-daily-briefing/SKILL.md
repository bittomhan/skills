...
11. **付费墙标注与复核机制**（2026-08-26 Tom 增设）：①凡因付费墙只能读到标题+摘要的条目，正文必须显式标注"⚠️付费墙"并说明细节以标题/摘要+第二信源交叉为准；②同时登记到滚动清单 `Web3/每日简报/_付费墙待复核清单.md`（一行=事件名｜原信源+URL｜原报道日｜缺失信息点）；③**每日开工读近两日简报后同步检查该清单**——若后续有其他媒体绕过付费墙提供了完整内容或此前缺失的关键信息（规模/条款/主体），按【事态进展】重新入选当日简报（视为当日新闻向 Tom 提供完整信息），并在条目内注明"付费墙复核完成、补全 XX"；仅重复无增量则维持不动；④复核完成后在清单中销账（标注复核日期与新信源）。
